...
def obtener_Pacientes():
    ...
    with conexion.cursor() as cursor:
        ...
        obtener_Pacientes = cursor.fetchall()
    conexion.close()
...
def actualizar_paciente(Id, Nombre, Primer_Apellido, Segundo_Apellido, Edad, Tipo_de_Sangre, Numero_Telefonico, Correo, Direccion):
    conexion = Connection()
    with conexion.cursor() as cursor:
